...
//=================================================================================================================================
    ...
    // Compatibility stubs - custom "main" prefix
    #define NRD_EXPORT
    ...
    #define NRD_CONSTANTS_START \
            ConstantBuffer globalConstants : register( b0 ) {
    ...
    #define EXPAND(x) x
    #define GET_NTH_MACRO_4_arg(_1, _2, _3, _4, NAME, ...) NAME
    #define GET_NTH_MACRO_3_arg(_1, _2, _3, NAME, ...) NAME
    ...
    #define InterlockedOr(...)          AtomicOr(__VA_ARGS__)
    #define InterlockedMax(...)         AtomicMax(__VA_ARGS__)
    #define InterlockedMin(...)         AtomicMin(__VA_ARGS__)
...
// Compatibility stubs - custom "main"
#ifndef NRD_CS_MAIN
...
#define REBLUR_BackEnd_UnpackRadiance( color )  ( color )

//========
// RELAX
//========

#define RELAX_BackEnd_UnpackRadiance( color )  ( color )
